...
/* harmony import */ var _nip65__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./nip65 */ "./scripts/nip65.js");
/* harmony import */ var _nip07__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./nip07 */ "./scripts/nip07.js");
...
const fetchNip65Relays = async (relays, pubkey) => {
  ...
  return _nip65__WEBPACK_IMPORTED_MODULE_0__.toReadWriteRelays(nip65Relays);
}

const fetchNip07Relays = async () => {
  const relayEntries = await window.nostr.getRelays();

  return _nip07__WEBPACK_IMPORTED_MODULE_1__.toReadWriteRelays(relayEntries);
}
...
const downloadPageHighlights = async () => {
  ...
  pool.subscribeMany(relays, [{
    ...
    onevent: (event) => {
      const isValid = (0,nostr_tools__WEBPACK_IMPORTED_MODULE_2__.verifyEvent)(event);
...
const showHighlightModal = (event, writeRelays) => {
  ...
  const npub = nostr_tools__WEBPACK_IMPORTED_MODULE_2__.nip19.npubEncode(event.pubkey);
  const nevent = nostr_tools__WEBPACK_IMPORTED_MODULE_2__.nip19.neventEncode({ id: event.id, relays: writeRelays, author: event.pubkey, kind: event.kind });
